...
export default function DonorForm() {
    ...
    return (
        <Stack direction="column" spacing={1}>
            ...
            <Stack direction="row" spacing={1} style={{alignSelf: 'center'}}>
                ...
                <FormControl style={{width: '100ch', alignSelf:'center'}}>
                    ...
                    <Select
                        ...
                        label="Answer"
                        onChange={e => {
                            handleChange2(e); handleChange(e)
                        }}
                    >
                        <MenuItem value={"Yes"}>Yes</MenuItem>
                        <MenuItem value={"No"}>No</MenuItem>
            ...
            <Stack direction="row" spacing={1} style={{alignSelf: 'center'}}>
                <FormControl style={{width: '100ch', alignSelf:'center'}}>
                    ...
                    <Select
                        ...
                        label="Answer"
                        onChange={e => {
                            handleChange3(e); handleChange(e)
                        }}
                    >
                        <MenuItem value={"Yes"}>Yes</MenuItem>
                        <MenuItem value={"No"}>No</MenuItem>
                ...
                <FormControl style={{width: '100ch', alignSelf:'center'}}>
                    ...
                    <Select
                        ...
                        label="Answer"
                        onChange={e => {
                            handleChange4(e); handleChange(e)
                        }}
                    >
                        <MenuItem value={"Yes"}>Yes</MenuItem>
                        <MenuItem value={"No"}>No</MenuItem>
            ...
            <Stack direction="row" spacing={1} style={{alignSelf: 'center'}}>
                <FormControl style={{width: '100ch', alignSelf:'center'}}>
                    ...
                    <Select
                        ...
                        label="Answer"
                        onChange={e => {
                            handleChange5(e); handleChange(e)
                        }}
                    >
                        <MenuItem value={"Yes"}>Yes</MenuItem>
                        <MenuItem value={"No"}>No</MenuItem>
                ...
                <FormControl style={{width: '100ch', alignSelf:'center'}}>
                    ...
                    <Select
                        ...
                        label="Answer"
                        onChange={e => {
                            handleChange6(e); handleChange(e)
                        }}
                    >
                        <MenuItem value={"Yes"}>Yes</MenuItem>
                        <MenuItem value={"No"}>No</MenuItem>
            ...
            <Stack direction="row" spacing={1} style={{alignSelf: 'center'}}>
                <FormControl style={{width: '100ch', alignSelf:'center'}}>
                    ...
                    <Select
                        ...
                        label="Answer"
                        onChange={e => {
                            handleChange7(e); handleChange(e)
                        }}
                    >
                        <MenuItem value={"Yes"}>Yes</MenuItem>
                        <MenuItem value={"No"}>No</MenuItem>
                ...
                <FormControl style={{width: '100ch', alignSelf:'center'}}>
                    ...
                    <Select
                        ...
                        label="Answer"
                        onChange={e => {
                            handleChange8(e); handleChange(e)
                        }}
                    >
                        <MenuItem value={"Yes"}>Yes</MenuItem>
                        <MenuItem value={"No"}>No</MenuItem>
            ...
            <Stack direction="row" spacing={1} style={{alignSelf: 'center'}}>
                <FormControl style={{width: '100ch', alignSelf:'center'}}>
                    ...
                    <Select
                        ...
                        label="Answer"
                        onChange={e => {
                            handleChange9(e); handleChange(e)
                        }}
                    >
                        <MenuItem value={"Yes"}>Yes</MenuItem>
                        <MenuItem value={"No"}>No</MenuItem>
                ...
                <FormControl style={{width: '100ch', alignSelf:'center'}}>
                    ...
                    <Select
                        ...
                        label="Answer"
                        onChange={e => {
                            handleChange10(e); handleChange(e)
                        }}
                    >
                        <MenuItem value={"Yes"}>Yes</MenuItem>
                        <MenuItem value={"No"}>No</MenuItem>
            ...
            <Stack direction="row" spacing={1} style={{alignSelf: 'center'}}>
                <FormControl style={{width: '100ch', alignSelf:'center'}}>
                    ...
                    <Select
                        ...
                        label="Answer"
                        onChange={e => {
                            handleChange11(e); handleChange(e)
                        }}
                    >
                        <MenuItem value={"Yes"}>Yes</MenuItem>
                        <MenuItem value={"No"}>No</MenuItem>
                ...
                <FormControl style={{width: '100ch', alignSelf:'center'}}>
                    <InputLabel id="demo-simple-select-label">Have you had tick bites in the past 12 months and have you
                    ...
                    <Select
                        ...
                        label="Answer"
                        onChange={e => {
                            handleChange12(e); handleChange(e)
                        }}
                    >
                        <MenuItem value={"Yes"}>Yes</MenuItem>
                        <MenuItem value={"No"}>No</MenuItem>
            ...
            <Stack direction="row" spacing={1} style={{alignSelf:'center'}}>
                <FormControl style={{width: '100ch', alignSelf:'center'}}>
                    ...
                    <Select
                        ...
                        label="Answer"
                        onChange={e => {
                            handleChange13(e); handleChange(e)
                        }}
                    >
                        <MenuItem value={"Yes"}>Yes</MenuItem>
                        <MenuItem value={"No"}>No</MenuItem>
                ...
                <FormControl style={{width: '100ch', alignSelf:'center'}}>
                    ...
                    <Select
                        ...
                        label="Answer"
                        onChange={e => {
                            handleChange14(e); handleChange(e)
                        }}
                    >
                        <MenuItem value={"Yes"}>Yes</MenuItem>
                        <MenuItem value={"No"}>No</MenuItem>
            ...
            <Button variant="contained" style={{width:200, alignSelf:'center'}} onClick={saveDonorForm}>Submit</Button>
        </Stack>
    );
}